...
public class LogServiceTest {
	...
	public void shouldListAllLogs() {
		List<LogError> log = from(LogError.class).gimme(2, LogTemplate.VALIDO);
		List<LogError> retornoLog = new ArrayList<>();
	...
	public void shouldListLogsById() {
		LogError log = from(LogError.class).gimme(LogTemplate.VALIDO);
		Optional<LogError> retornoLog;
